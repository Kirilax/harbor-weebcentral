// MangaDex Korean-origin manhwa with English translations for Harbor.
...
const HEADERS = {
  ...
  "user-agent": "Harbor-MangaDex-Manhwa/1.0.0"
};
...
const plugin = {
  id: "mangadex-manhwa-en",
  name: "MangaDex Manhwa (Korean → English)",
